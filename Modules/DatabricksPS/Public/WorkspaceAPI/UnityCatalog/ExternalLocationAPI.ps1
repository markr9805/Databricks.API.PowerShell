...
Function Add-UnityCatalogExternalLocation {
	...
	(
		...
		[Parameter(Mandatory = $true, ValueFromPipelineByPropertyName = $true)] [string] [Alias("credential", "credential_name")]$CredentialName,
...
Function Update-UnityCatalogExternalLocation {
	...
	(	
		...
		[Parameter(Mandatory = $false, ValueFromPipelineByPropertyName = $true)] [string] [Alias("credential", "credential_name")]$CredentialName,
		[Parameter(Mandatory = $false, ValueFromPipelineByPropertyName = $true)] [string] $Comment,
